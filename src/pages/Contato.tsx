...
const Contato = () => {
  return <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
          ...
          <div className="container mx-auto max-w-5xl">
            <div className="text-center mb-16 animate-fade-in">
              ...
              <p className="text-xl text-slate-600 mb-12 max-w-3xl mx-auto leading-relaxed">
                ...
                <strong>Consultoria gratuita</strong> para descobrir o potencial da sua empresa.
              </p>
            </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-white/50 text-center">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-sm text-slate-600">Seus dados estão protegidos</p>
                </div>
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-3">
                    <Zap className="w-6 h-6 text-blue-600" />
                  </div>
                  <h4 className="font-semibold text-slate-900 mb-1">Resposta Rápida</h4>
                  <p className="text-sm text-slate-600">Máximo 12h para retorno</p>
                </div>
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center mb-3">
                    <Shield className="w-6 h-6 text-purple-600" />
                  </div>
                  <h4 className="font-semibold text-slate-900 mb-1">Sem Compromisso</h4>
                  <p className="text-sm text-slate-600">Consultoria inicial gratuita</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Services Preview */}
        <section className="py-20 px-4 lg:px-6 bg-white/50">
